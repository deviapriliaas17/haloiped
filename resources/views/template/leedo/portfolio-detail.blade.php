...
<div class="vlt-site-wrapper__inner">
											...
											<ul class="sub-menu">
												...
												<li class="menu-item-has-children left"><a href="single-work-01.html"><span>Single Work</span></a>
													<ul class="sub-menu">
														...
														<li class=" current-menu-item"><a href="single-work-05.html"><span>Style 05</span></a>
														</li>
											...
											<ul class="sub-menu">
												...
												<li class="menu-item-has-children left"><a href="single-post-01.html"><span>Single Post</span></a>
													<ul class="sub-menu">
														...
														<li class=" current-menu-item"><a href="single-post-05.html"><span>Style 05</span></a>
														</li>
	...
	<main class="vlt-main">
					...
					<div class="swiper-container">
						<div class="swiper-wrapper">
							...
							<div class="vlt-simple-image">
								<div class="vlt-fit-image" style="--size-md: 590px; --size-sm: 100%;"><img src=" {{ asset('template/leedo/assets/img/attachment-39.jpg')}}" alt=""></div>
							</div>
							<!--Simple Image-->
							<div class="vlt-simple-image">
								<div class="vlt-fit-image" style="--size-md: 590px; --size-sm: 100%;"><img src=" {{ asset('template/leedo/assets/img/attachment-40.jpg')}}" alt=""></div>
							</div>
							<!--Simple Image-->
							<div class="vlt-simple-image">
								<div class="vlt-fit-image" style="--size-md: 590px; --size-sm: 100%;"><img src=" {{ asset('template/leedo/assets/img/attachment-41.jpg')}}" alt=""></div>
							</div>
						</div>
		...
		<section class="position-relative overflow-hidden">
			<!--Particle-->
			<div class="vlt-particle" data-jarallax-element="100 0" style="top: -30px; right: -40px; max-width: 250px;"><img src=" {{ asset('template/leedo/assets/img/root/particle-01--black.png')}}" alt=""></div>
				...
				<div class="row">
					...
					<div class="col-md-6 offset-md-1">
						...
						<div class="vlt-animation-block" data-aos="fade" data-aos-delay="100">
							...
							<p>Let. Gathered hath doesn’t air, unto his brought morning. Creepeth deep, dry whales. Given light, moving our. Third greater them replenish fourth. Us give multiply stars grass is to she’d and beast. Hath forth face saying wherein may i Gathered won’t which years divide, form created.</p>
						</div>
					...
					<div class="col-md-3 offset-md-1">
						...
						<div class="vlt-animation-block" data-aos="fade" data-aos-delay="200">
							...
							<dl class="vlt-work-meta text-left">
								...
								<dd><a href="website.com">website.com</a></dd>
							</dl>
						</div>
					</div>
				</div>
					...
					<div class="col-md-6 offset-md-3">
						...
						<div class="vlt-testimonial-item vlt-testimonial-item--style-1">
							...
							<div class="vlt-testimonial-item__content">
								<p data-swiper-parallax="-280" style="color:#fff;">Years living hath lights all from fifth all image. Fill likeness fly rule. Second beginning had likeness earth made, deep second.
								</p>
							</div>
		...
		<section>
			...
			<div class="container position-relative">
				<!--Particle-->
				<div class="vlt-particle" data-jarallax-element="-100 0" style="top: 75px; left: calc(-75px + 15px); max-width: 150px;"><img src=" {{ asset('template/leedo/assets/img/root/particle-02.png')}}" alt=""></div>
				<!--Particle-->
				<div class="vlt-particle" data-jarallax-element="100 0" style="top: 70px; right: calc(-160px + 15px); max-width: 250px;"><img src=" {{ asset('template/leedo/assets/img/root/particle-01--black.png')}}" alt=""></div>
				<div class="row">
					<div class="col-md-6 offset-md-3">
						<!--Animation Block-->
						<div class="vlt-animation-block" data-aos="fade" data-aos-delay="0">
					...
					<div class="col-md-4">
						...
						<div class="vlt-animation-block" data-aos="fade" data-aos-delay="200">
							...
							<article class="vlt-portfolio-item vlt-portfolio-item--style-2 filter-graphic-design">
								<div class="vlt-portfolio-item-img">
									<div class="vlt-fit-image" style="--size-md: 90%; --size-sm: 90%;"><img src=" {{ asset('template/leedo/assets/img/portfolio-12.jpg')}}" alt=""></div>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="d-flex col">
					<h5 class="vlt-display-1"><a class="prev" href="single-work-04.html"><span>Prev Work</span></a></h5>
				</div>
				<div class="d-flex col justify-content-center"><a class="all" href="portfolio-01.html"><span></span><span></span><span></span><span></span></a></div>
				<div class="d-flex col justify-content-end">
					<h5 class="vlt-display-1"><a class="next" href="single-work-06.html"><span>Next Work</span></a></h5>
				</div>
			</div>
		</div>
	</nav>
