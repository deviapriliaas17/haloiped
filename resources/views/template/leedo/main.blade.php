<!DOCTYPE html>
<html class="no-js vlt-is--homepage-05 vlt-is--header-default vlt-is--footer-widgetized vlt-is--footer-fixed vlt-is--lowercase-mode" lang="en">
<head>
	<meta charset="utf-8">
	<title>{{ isset($content) ? $content->title  : 'HaloIped' }}</title>
	<meta name="description" content="Modern, Colorful &amp; Creative Portfolio HTML5 Template">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	<!--Favicon-->
	<link rel="icon" type="image/png" href="{{ asset('template/leedo/assets/img/root/favicon.png')}}">
	<!--Framework-->
	<link rel="stylesheet" href="{{ asset('template/leedo/assets/css/framework/bootstrap.min.css')}}">
	<!--Plugins-->
	<link rel="stylesheet" href="{{ asset('template/leedo/assets/css/vlt-plugins.css')}}">
	<!--RevSlider-->
	<link rel="stylesheet" href="{{ asset('template/leedo/assets/revolution/css/settings.css')}}">
	<!--Fonts-->
	...
	<!--Icons-->
	<link rel="stylesheet" href="{{ asset('template/leedo/assets/fonts/fontawesome/font-awesome.min.css')}}">
	<link rel="stylesheet" href="{{ asset('template/leedo/assets/fonts/leedo/style.css')}}">
	<!--Style-->
	<link rel="stylesheet" href="{{ asset('template/leedo/assets/css/vlt-style.min.css')}}">
	<!--Custom-->
	<link rel="stylesheet" href="{{ asset('template/leedo/assets/css/custom.css')}}">
</head>

<body>
	<!--Preloader-->
	<div class="vlt-site-preloader">
		<div class="image"><img href="{{ asset('template/leedo/assets/img/root/preloader.gif')}}" alt=""></div>
	</div>
	<!--Site Wrapper-->
							...
							<div class="vlt-navbar-inner">
								...
								<div class="vlt-navbar-inner--right">
									<div class="d-flex align-items-center">
										...
										</nav><a class="vlt-menu-shop-cart" href="shop-cart.html"><i class="leedo-paper-bag"></i><span>0</span></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4">
							...
							<div class="vlt-widget vlt-widget--white vlt-widget-text">
								<h5 class="vlt-widget__title vlt-widget__title--white">About Leedo</h5>
	...
	<!--Libs-->
	<script src="{{ asset('template/leedo/assets/scripts/vlt-plugins.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/scripts/vlt-helpers.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/scripts/vlt-controllers.min.js')}}"></script>
	<!--RevSlider-->
	<script src="{{ asset('template/leedo/assets/revolution/js/jquery.themepunch.tools.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/revolution/js/jquery.themepunch.revolution.min.js')}}"></script>
	<!--RevSlider Extensions-->
	<script src="{{ asset('template/leedo/assets/revolution/js/extensions/revolution.extension.actions.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/revolution/js/extensions/revolution.extension.carousel.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/revolution/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/revolution/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/revolution/js/extensions/revolution.extension.migration.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/revolution/js/extensions/revolution.extension.navigation.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/revolution/js/extensions/revolution.extension.parallax.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/revolution/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
	<script src="{{ asset('template/leedo/assets/revolution/js/extensions/revolution.extension.video.min.js')}}"></script>
	<!--Google Maps-->
