                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item-has-children left"><a href="single-work-01.html"><span>Single Work</span></a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class=" current-menu-item"><a href="single-work-07.html"><span>Style 07</span></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item-has-children left"><a href="single-post-01.html"><span>Single Post</span></a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class=" current-menu-item"><a href="single-post-07.html"><span>Style 07</span></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="vlt-simple-image">
                                        <div class="vlt-fit-image" style="--size-md: 48.7%; --size-sm: 80%;"><img src="assets/img/attachment-22.jpg" alt=""></div>
                                    </div>
                                    <!--Simple Image-->
                                    <div class="vlt-simple-image">
                                        <div class="vlt-fit-image" style="--size-md: 48.7%; --size-sm: 80%;"><img src="assets/img/attachment-25.jpg" alt=""></div>
                                    </div>
                                    <!--Simple Image-->
                                    <div class="vlt-simple-image">
                                        <div class="vlt-fit-image" style="--size-md: 48.7%; --size-sm: 80%;"><img src="assets/img/attachment-24.jpg" alt=""></div>
                                    </div>
                                </div>
                            ...
                            <div class="vlt-sidebar vlt-sidebar--left">
                                ...
                                <div class="vlt-widget vlt-widget-instagram">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#"><img src="assets/img/instagram/2.png" alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/instagram/3.png" alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/instagram/4.png" alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/instagram/5.png" alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/instagram/6.png" alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/instagram/7.png" alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/instagram/8.png" alt=""></a></li>
                                    </ul>
                                </div>
                                <!--Widget-->
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <article class="vlt-widget-post">
                                                <div class="vlt-widget-post__thumbnail"><a href="single-post-01.html"><img src="assets/img/post-thumbnail-01--sm.jpg" alt=""></a></div>
                                        ...
                                        <li>
                                            <!--Blog Post-->
                                            <article class="vlt-widget-post">
                                                <div class="vlt-widget-post__thumbnail"><a href="single-post-02.html"><img src="assets/img/post-thumbnail-02--sm.jpg" alt=""></a></div>
                                                <div class="vlt-widget-post__content">
                                        ...
                                        <li>
                                            <!--Blog Post-->
                                            <article class="vlt-widget-post">
                                                <div class="vlt-widget-post__thumbnail"><a href="single-post-03.html"><img src="assets/img/post-thumbnail-03--sm.jpg" alt=""></a></div>
                                                <div class="vlt-widget-post__content">
                        ...
                        <div class="col-md-8">
                            ...
                            <article class="vlt-single-post">
                                ...
                                <header class="vlt-single-post__header vlt-single-post__header--style-1">
                                    <h2 class="vlt-post-title">That you’re appear image have spirit signs blessed.</h2>
                                    <div class="vlt-post-meta vlt-display-1"><span>13 August 2018</span><span>Design</span></div>
                                </header>
                                <!--Post Content-->
                                <div class="vlt-single-post__content vlt-content-markup clearfix">
                                    ...
                                    <p>Said isn’t fruitful bring creeping don’t. Heaven. Living appear god hath deep firmament is itself god. Dry may. Night. Days first spirit. Dominion created together. You’ll life creeping saying he that, from, firmament image divide itself.</p>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <article class="vlt-post filter-branding vlt-post--style-also-like">
                                            <div class="vlt-post-thumbnail clearfix">
                                                <div class="vlt-fit-image" style="--size-md: 67.5%; --size-sm: 67.5%;"><img src="assets/img/attachment-12.jpg" alt=""></div><a class="vlt-post-thumbnail__link" href="single-post-01.html"></a>
                                            </div>
                            ...
                            <div class="vlt-comments vlt-comments--style-2">
                                ...
                                <ul class="vlt-comments__list">
                                    ...
                                    <li class="vlt-comment-item">
                                        <div class="vlt-comment-item__inner clearfix"><a class="vlt-comment-avatar" href="#"><img src="assets/img/avatar-01.jpg" alt="" style="max-width: 100px;"></a>
                                        ...
                                        <ul class="children">
                                            <!--Comment Item-->
                                            <li class="vlt-comment-item">
                                                <div class="vlt-comment-item__inner clearfix"><a class="vlt-comment-avatar" href="#"><img src="assets/img/avatar-02.jpg" alt="" style="max-width: 100px;"></a>
                                                    <div class="vlt-comment-content">
                                                        <div class="vlt-comment-header">
                                                            <h5>Jessica Reed</h5>
                                                            <div class="vlt-comment-header__metas"><span>24 August 2018</span><a class="vlt-comment-reply-link" href="#">Reply</a></div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="d-flex col">
                        <h5 class="vlt-display-1"><a class="prev" href="single-post-06.html"><span>Prev Post</span></a></h5>
                    </div>
                    <div class="d-flex col justify-content-center"><a class="all" href="blog-01.html"><span></span><span></span><span></span><span></span></a></div>
