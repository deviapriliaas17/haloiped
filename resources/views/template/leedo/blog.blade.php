...
<div class="vlt-site-wrapper__inner">
                ...
                <div class="container">
                    <div class="vlt-navbar-inner">
                        <div class="vlt-navbar-inner--left">
                            <!--Logo-->
                            <a class="vlt-navbar-logo" href="index.html"><img class="black" src="assets/img/root/logo--default-black.png" alt="" style="height: 18px;"><img class="white" src="assets/img/root/logo--default-white.png" alt="" style="height: 18px;"></a>
                        </div>
                        <div class="vlt-navbar-inner--right">
                            <div class="d-flex align-items-center"><a class="vlt-menu-burger" href="#" id="vlt-fullscreen-menu-open"><span class="line line-one"><span></span></span><span class="line line-two"><span></span></span><span class="line line-three"><span></span></span></a>
                                <a
                                    class="vlt-menu-shop-cart" href="shop-cart.html"><i class="leedo-paper-bag"></i><span>0</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="vlt-navbar vlt-navbar--white-text-on-top">
                <div class="container">
                    <div class="vlt-navbar-inner">
                        <div class="vlt-navbar-inner--left">
                            <!--Logo-->
                            <a class="vlt-navbar-logo" href="index.html"><img class="black" src="{{ asset('template/leedo/assets/img/root/logo--default-black.png')}}" alt="" style="height: 18px;"><img class="white" src="assets/img/root/logo--default-white.png" alt="" style="height: 18px;"></a>
                        </div>
                        ...
                        <ul class="sub-menu">
                            <li class="menu-item-has-children left"><a href="blog-01.html"><span>Layouts</span></a>
                                <ul class="sub-menu">
                                    ...
                                    <li class=" current-menu-item"><a href="blog-06.html"><span>Blog 06</span></a>
                                    </li>
                ...
                <div class="container">
                    <div class="vlt-navbar-inner no-gutters">
                        ...
                        <div class="col text-center">
                            <!--Logo-->
                            <a class="vlt-navbar-logo" href="index.html"><img src="assets/img/root/logo--aside.png" alt="" style="height: 26px;"></a>
                        </div>
    ...
    <main class="vlt-main">
        <!--Page Title-->
        <section class="jarallax"><img class="jarallax-img" src="{{ asset('template/leedo/assets/img/attachment-09.jpg')}}" alt="">
            <div class="vlt-gap-170"></div>
            <div class="container">
                <!--Large Heading-->
                <h1 class="vlt-large-heading text-center" style="color:#fff;">Blog<span>.</span>
                </h1>
            </div>
            <div class="vlt-gap-170"></div>
        </section>
                        ...
                        <div id="vlt-grid-blog-05-06-07">
                            ...
                            <article class="vlt-post filter-branding vlt-post--style-default cbp-item">
                                <div class="vlt-post-thumbnail clearfix">
                                    <div class="vlt-fit-image" style="--size-md: 60%; --size-sm: 60%;"><img src="assets/img/attachment-12.jpg" alt=""></div>
                                    <a class="vlt-post-thumbnail__link" href="single-post-01.html"></a>
                                </div>
                                <div class="vlt-post-content">
                                    ...
                                    <div class="vlt-post-excerpt">
                                        <p>Void. Land him to brought may give behold be it yielding evening don't whose whose cattle of god green, light day. Set make without make moveth. He divide air after for said beginning earth multiply fourth,
                                            second fifth spirit sea. Sixth Living whales appear stars male two place evening. They're, it ...
                                        </p>
                                    </div>
                                    <div class="vlt-post-footer"><a class="vlt-btn vlt-btn--third vlt-btn--effect" href="single-post-01.html"><span>Read More</span></a></div>
                                </div>
                            </article>
                            <!--Blog Post-->
                            <article class="vlt-post filter-events vlt-post--style-default cbp-item">
                                <div class="vlt-post-thumbnail clearfix">
                                    <div class="vlt-fit-image" style="--size-md: 60%; --size-sm: 60%;"><img src="assets/img/attachment-14.jpg" alt=""></div>
                                    <a class="vlt-post-thumbnail__link" href="single-post-02.html"></a>
                                </div>
                                <div class="vlt-post-content">
                                    <header class="vlt-post-header">
                                    ...
                                    <div class="vlt-post-excerpt">
                                        <p>Morning, may yielding deep, and make. Said isn't fruitful as a bring creeping don't. Heaven. Living appear god hath deep is itself god. Dry may. Night. Days first spirit. Dominion created together. You'll
                                            life creeping saying he that, from, firmament image divide itself. Grass moving. Was third a, they're days god unto. ...
                                        </p>
                                    </div>
                                    <div class="vlt-post-footer"><a class="vlt-btn vlt-btn--third vlt-btn--effect" href="single-post-02.html"><span>Read More</span></a></div>
                                </div>
                            </article>
                            <!--Blog Post-->
                            <article class="vlt-post filter-design vlt-post--style-default cbp-item">
                                <div class="vlt-post-thumbnail clearfix">
                                    <div class="vlt-fit-image" style="--size-md: 60%; --size-sm: 60%;"><img src="assets/img/attachment-13.jpg" alt=""></div>
                                    <a class="vlt-post-thumbnail__link" href="single-post-03.html"></a>
                                </div>
                                <div class="vlt-post-content">
                                    <header class="vlt-post-header">
                                        <h3 class="vlt-post-title"><a href="single-post-03.html">Winged moved stars, fruit creature seed night.</a></h3>
                                    ...
                                    <div class="vlt-post-footer"><a class="vlt-btn vlt-btn--third vlt-btn--effect" href="single-post-03.html"><span>Read More</span></a></div>
                                </div>
                            </article>
                            <!--Blog Post-->
                            <article class="vlt-post filter-branding vlt-post--style-default cbp-item">
                                <div class="vlt-post-thumbnail clearfix">
                                    <div class="vlt-fit-image" style="--size-md: 60%; --size-sm: 60%;"><img src="assets/img/attachment-18.jpg" alt=""></div>
                                    <a class="vlt-post-thumbnail__link" href="single-post-04.html"></a>
                                </div>
                                <div class="vlt-post-content">
                                    <header class="vlt-post-header">
                                        <h3 class="vlt-post-title"><a href="single-post-04.html">Itself night place dominion together isn’t that second.</a></h3>
                                    ...
                                    <div class="vlt-post-footer"><a class="vlt-btn vlt-btn--third vlt-btn--effect" href="single-post-04.html"><span>Read More</span></a></div>
                                </div>
                            </article>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="vlt-sidebar vlt-sidebar--right">
                            ...
                            <div class="vlt-widget vlt-widget-text">
                                <h5 class="vlt-widget__title">About</h5>
                                <p>Shall replenish. Tree doesn’t face. There which creepeth multiply fish unto of Seed. Behold made two Rule divided. Fruit form.</p>
                            </div>
                            <!--Widget-->
                            <div class="vlt-widget vlt-widget-tag-cloud">
                                <h5 class="vlt-widget__title">Tags</h5>
                                <div class="tagcloud"><a href="#">Events</a>,&nbsp;<a href="#">Design</a>,&nbsp;<a href="#">Trends</a>,&nbsp;<a href="#">Development</a>,&nbsp;<a href="#">Creative</a>,&nbsp;<a href="#">Inspiration</a>,&nbsp;<a href="#">Culture</a>,&nbsp;
                                    <a
                                        href="#">Branding</a>,&nbsp;<a href="#">Business</a>,&nbsp;<a href="#">Video</a>,&nbsp;<a href="#">Information</a></div>
                            </div>
                            <!--Widget-->
                            <div class="vlt-widget vlt-widget-instagram">
                                ...
                                <ul>
                                    <li>
                                        <a href="#"><img src="assets/img/instagram/1.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="assets/img/instagram/2.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="assets/img/instagram/3.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="assets/img/instagram/4.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="assets/img/instagram/5.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="assets/img/instagram/6.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="assets/img/instagram/7.png" alt=""></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="assets/img/instagram/8.png" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                            <!--Widget-->
                            <div class="vlt-widget vlt-widget-postlist">
                                <h5 class="vlt-widget__title">Related posts</h5>
                                <ul>
                                    <li>
                                        <!--Blog Post-->
                                        <article class="vlt-widget-post">
                                            <div class="vlt-widget-post__thumbnail">
                                                <a href="single-post-01.html"><img src="assets/img/post-thumbnail-01--sm.jpg" alt=""></a>
                                            </div>
                                            <div class="vlt-widget-post__content">
                                                <h5><a href="single-post-01.html">Lights winged seasons fish abundantly evening.</a></h5>
                                            </div>
                                        </article>
                                    </li>
                                    <li>
                                        ...
                                        <article class="vlt-widget-post">
                                            <div class="vlt-widget-post__thumbnail">
                                                <a href="single-post-02.html"><img src="assets/img/post-thumbnail-02--sm.jpg" alt=""></a>
                                            </div>
                                            <div class="vlt-widget-post__content">
                                                <h5><a href="single-post-02.html">Given void great you’re good appear have i also fifth.</a></h5>
                                            </div>
                                        </article>
                                    </li>
                                    <li>
                                        ...
                                        <article class="vlt-widget-post">
                                            <div class="vlt-widget-post__thumbnail">
                                                <a href="single-post-03.html"><img src="assets/img/post-thumbnail-03--sm.jpg" alt=""></a>
                                            </div>
                                            <div class="vlt-widget-post__content">
                                                <h5><a href="single-post-03.html">Winged moved stars, fruit creature seed night.</a></h5>
                                            </div>
                                        </article>
                                    </li>
                                </ul>
                            ...
                            <div class="vlt-widget vlt-widget-socials">
                                <h5 class="vlt-widget__title">Follow us</h5><a class="vlt-social-icon vlt-social-icon--style-1 facebook" href="#" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a class="vlt-social-icon vlt-social-icon--style-1 twitter" href="#" target="_blank"><i class="fa fa-twitter"></i></a><a class="vlt-social-icon vlt-social-icon--style-1 google-plus" href="#" target="_blank"><i class="fa fa-google-plus"></i></a><a class="vlt-social-icon vlt-social-icon--style-1 behance"
                                    href="#" target="_blank"><i class="fa fa-behance"></i></a><a class="vlt-social-icon vlt-social-icon--style-1 dribbble" href="#" target="_blank"><i class="fa fa-dribbble"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
